...
cmd1=Serial.readStringUntil(':');  // BINARY COMMAND FOR THE GPIO-A
//cmd_i=Serial.readStringUntil(':');  // BINARY COMMAND FOR THE GPIO-i, they come separated by :
cmd2=Serial.readStringUntil('\r'); // BINARY COMMAND FOR THE GPIO-B, the last always comes before \r
